export default {
  ...
  index: {
    ...
    badges: {
      'self-taught': 'Auto-Didacte',
      fullstack: 'Développeur Fullstack',
      student: 'Étudiant',
      freelancer: 'Freelancer',
      design: 'Design Visual',
      'dev-experience': 'Experience Développeur',
      leader: 'Leader',
      mentor: 'Mentor',
      devops: 'Ingénieur DevOps',
      'open-source': 'Contributeur Open Source',
      memer: 'Memer',
      'ui-ux': 'UI/UX Designer',
      pianist: 'Pianiste',
      remote: 'Travail À Distance',
      chess: "Joueur d'Échecs",
      'os-x': 'Utilisateur OS X',
      vsc: 'Utilisateur Visual Studio Code',
      less: 'Cacher',
    },
    about: {
      title: 'Salut toi!',
